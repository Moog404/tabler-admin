...
export default class extends Controller {
    initialize()  {
        ...
        a2lix_lib.sfCollection = (() => {
            ...
            // ------------------------
            const appendEntryAddHr = collectionElt => {
                // Allow custom label
                const entryLabel = document.createElement('HR')
                collectionElt.appendChild(entryLabel)
            }
            // ------------------------
    ...
    //             // customConfig: './back/js/ckeditor/custom/ckeditor_config.js'
    //             customConfig: ''
    //         });
    //     });
    // }
